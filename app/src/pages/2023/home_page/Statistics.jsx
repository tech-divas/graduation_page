...
export default function Statistics() {
    const option = {
        ...
        yAxis: {
          type: 'category',
          data: ['Back-end Development', 'Front-end Development','Business analysis, Business Intelligence & Analytics', 'IT Administration','Product Ownership', 'Project & Product management', 'QA & Testing',  'UX/UI Design', 'App & Mobile Development', 'Cybersecurity', 'Startups & Entrepreneurship','No IT field mentioned'],
          axisLabel: {
            textStyle: {
              fontFamily: 'PT Mono', 
              color: 'white'
    ...
    return(
        ...
        <div className="chart">
        <ReactECharts option={option} style={{ width: '80%', margin: '0 auto' }} />
        </div>
        </>
    )
}

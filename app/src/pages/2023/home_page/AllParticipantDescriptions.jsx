    ...
    <div className="allParticipants">
      <div className="participant mentors">
        ...
        <div className="textContent">
          <p>
            Our program's mentors are dedicated professionals who empower women
            in technology through personalized guidance and support, offering
            1:1 sessions and fostering open communication. They commit several
            hours weekly to mentoring and can also lead practice project teams,
            enhancing both personal and professional growth. By participating,
            mentors refine their leadership skills, expand their network, and
      ...
      <div className="participant experts-speakers">
        ...
        <div className="textContent">
          <p>
            ...
            the team's objectives. By actively engaging with project teams, they
            enrich participants' learning journeys and foster a collaborative
            environment of continuous growth and development.{" "}
